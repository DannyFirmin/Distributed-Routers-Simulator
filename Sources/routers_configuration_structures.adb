...
package body Routers_Configuration_Structures is
   ...
   function Get_Topology (Command_Line_Parameters : Command_Line_Defaults) return Topology_Kind'Class is

      CLP : Command_Line_Defaults renames Command_Line_Parameters;
